    ...
    <div class="backups-list">
        ...
        <table class="wp-list-table widefat striped" data-element="backupsTable">
            ...
            <tr class="no-backups-yet"
                style="display:<?php echo ( count( $data['backups'] ) === 0 ) ? 'table-row' : 'none'; ?>"
                data-element="noBackups">
                <td colspan="5">
					<?php _e( 'No backups yet. Create a <a href=# data-action="createBackup">new one</a> right now.',
						$data['key'] ); ?>
                </td>
            </tr>
